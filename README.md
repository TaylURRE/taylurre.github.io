...
1.  **Open the source code and start editing!**
    ...
    changes are hot reloaded so no need to restart the application when making changes in the editor.
...
[![Deploy via Github Pages](https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png)](https://www.gatsbyjs.org/docs/how-gatsby-works-with-github-pages)
